@foreach ($addresses as $address) 
    <div address-id={{ $address->id }} class="delivery-add-item w-auto mr-2 ml-2 flex-column align-items-start shipping-address-button cursor-pointer" data-dismiss="modal">
